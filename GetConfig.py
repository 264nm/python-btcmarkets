...
class GetConfig(OpenConfig):
    ...
    @property
    def api_host(self):
        self._api_host = self.config_dict['btc_markets']['api_host']
    ...
    def api_username(self):
        self._api_username = self.config_dict['btc_markets']['api_username']
    ...
    def api_key_public(self):
        self._api_key_public = self.config_dict['btc_markets']['api_key_public']
    ...
    def api_key_secret(self):
        self._api_key_secret = self.config_dict['btc_markets']['api_key_secret']
